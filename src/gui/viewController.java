...
public class viewController implements Initializable {
	...
	@FXML
	public void onMenuSobreItemVersao() {
		loadView("/gui/Versao.fxml");
	}
	
	@FXML
	public void onmenuSobreItemAutor() {
...
/*
 O objetivo do método de loadView é carregar uma view na janela principal da aplicação.
 Para isso precisamos pegar uma referência da ca cena principal, que foi criada na classe 
 Main.
 Uma vez a referência da Cena principal tenha sido exposta na classe Main, podemos obter 
  uma referência aqui no método de loadView para manipularmos a janela principal da 
  aplicação.
 */
	...
	public synchronized void loadView(String absolutName) {
		try {
			...
			//fazendo o casting de scrooPane que é o componente da cena principal, para o VBox
			...
			//caso acontece algum erro, emitirá um alerta, conforme implementado anteriormente
			//possíveis erros aqui é 1) não conseguir obter uma referência da cena principal,
			//2)não conseguir carregar alguma tela, 3) não encontrar os componentes da VBox principal
